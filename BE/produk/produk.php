                ...
                <main class="bg-light text-center">
                    <div class="card">
                        <div class="card-header bg-info">
                            <h3 class="text-center text-uppercase text-white my-3">Daftar Produk</h3>
                        </div>
                        <div class="card-body">
                            <div class="container">
                                <a class="btn btn-success mb-2" href="form_produk.php" role="button">Buat Produk</a>
                                <table class="table table-hover table-bordered" width="100%" border="1" cellspacing="2" cellpadding="2">
                                    ...
                                    <?php 
                                    // $sql = "SELECT produk.*,merk.* FROM produk LEFT JOIN merk ON produk.merk_id = merk.id"; 
